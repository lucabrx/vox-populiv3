...
import DeleteNewsCommentModal from '@/components/modals/DeleteNewsComment';
...
import EditNewsCommentModal from '@/components/modals/EditNewsComment';

import Button from '@/components/ui/Button';
import IconContainer from '@/components/ui/IconContainer';
import useDeleteNewsCommentModal from '@/hooks/useDeleteNewsModal';
import useEditNewsCommentModal from '@/hooks/useEditNewsComment';
...
const CommentMenu: FC<CommentMenuProps> = ({params,userId,commentId,body}) => {
    ...
    const updateComment = useEditNewsCommentModal()
  ...
  return (
<>
<DeleteNewsCommentModal
params={params}
commentId={commentId}
userId={userId}
/>

<EditNewsCommentModal
body={body}
params={params}
commentId={commentId}
userId={userId}
