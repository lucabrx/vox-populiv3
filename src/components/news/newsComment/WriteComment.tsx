...
import { createCommentSchema,createCommentType } from '@/schema/newsComment.schema';
...
mutationFn: (data: createCommentType) => (
  axios.post(`/api/comments/news/create`, data)
),
onSuccess: () => {
...
onSettled: () => {
 ...
 useEffect(() => {
   setValue("newsId", newsId!)
 }, [createComment,setValue,reset,newsId])
