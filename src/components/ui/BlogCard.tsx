...
<Link href={`/news/${data.Blog.id}`} className='font-semibold text-xl text-my-neutral-950 dark:text-my-neutral-50 hover:text-my-primary-500 hover:dark:text-my-primary-500 duration-300 transition-all'>
{data.Blog.title}
</Link>
</div>
