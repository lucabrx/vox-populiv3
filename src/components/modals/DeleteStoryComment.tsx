...
const DeleteStoryCommentModal: FC<DeleteCommentModalProps> = ({params,commentId,userId}) => {
    ...
    const deleteCommentMutation = useMutation({
        mutationFn: () => (axios.post("/api/comments/story/delete", {commentId, userId})),
        onMutate: () => {
            setIsLoading(true)
        },
        onSuccess: () => {
...
export default DeleteStoryCommentModal