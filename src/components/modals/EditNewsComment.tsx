...
import {  updateCommentType, updateCommentSchema } from '@/schema/newsComment.schema';
...
const EditNewsCommentModal: FC<DeleteCommentModalProps> = ({params,commentId,userId,body}) => {
    ...
    const editCommentMutation = useMutation({
        mutationFn: (data : updateCommentType) => (axios.post("/api/comments/blog/update", {
            body: data.body,
            userId: data.userId,
...
export default EditNewsCommentModal